...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        if (now > 0 && now <= 6) {
            ...
            showMessage(visitor + ' 下班时间！自由的空间就是爽！', 6000);
        } else if (now > 22 && now <= 24) {
            showMessage(visitor + ' 早睡早起好习惯！明早起来好上班！', 6000);
        }else {
